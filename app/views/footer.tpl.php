        ...
        <div id="footer-menu" class="py-5">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Liste des 5 marques footer -->
                    <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
                        <h6 class="text-uppercase text-dark mb-3">Marques</h6>

                        <ul class="list-unstyled">
                            <?php //dump($viewVars['infos-brands']); 
                            // TODO
                            foreach ($viewVars['infos-brands'] as $brand):?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
                            <li class="list-inline-item">
                                <img src="<?php echo $viewVars['baseUrl'] ?>/assets/img/visa.svg" alt="..." class="payment-icon">
                            </li>
                            <li class="list-inline-item">
                                <img src="<?php echo $viewVars['baseUrl'] ?>/assets/img/mastercard.svg" alt="..." class="payment-icon">
                            </li>
                            <li class="list-inline-item">
                                <img src="<?php echo $viewVars['baseUrl'] ?>/assets/img/paypal.svg" alt="..." class="payment-icon">
                            </li>
                        </ul>
                    </div>
                </div>
